<?php
    ...
    $link = mysqli_connect("localhost","id326931_twitter","twitter","id326931_twitterdb");
    ...
    function displayTweets($type){
        ...
        if(mysqli_num_rows($result) == 0){
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<p class='link'><a   class='toggleFollow' data-userID='".$row['userid']."'>";
                ...
                $isFollowresult = mysqli_query($link,$isFollowingquery);
   
                if(mysqli_num_rows($isFollowresult)>0){
                    echo "Unfollow";
                }else{
                    echo "Follow";
                }
  ...
  <button  class="btn btn-primary" href="?page=search">Search Tweets</button>
</form>';
    }
